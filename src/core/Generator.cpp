...
Generator::Generator(const AbstractGeometry* geom, std::unique_ptr<Object> obj)
  : Generator(
...
Generator::Generator(const AbstractGeometry* geom, GeometryGenerator* restrictor, double posValue)
  : Generator(
